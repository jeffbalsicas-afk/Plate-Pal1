...
>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-2xl border border-[#EDE4D8] shadow-lg overflow-hidden">
            ...
            <form method="POST" action="{{ route('menu.packages.update', $package) }}" class="p-6 sm:p-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        <label for="price" class="block text-sm font-bold text-[#1C1A17] mb-2">Price per Head *</label>
                        <input
                            id="price"
                            name="price"
                            type="number"
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="live" @selected(old('status', $package->status) === 'live')>Live</option>
                    </select>
                    @error('status')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
