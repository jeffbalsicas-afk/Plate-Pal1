<form x-show="formType === 'addons'" action="{{ route('menu.addons.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
    @csrf
    <label class="block">
    ...
    <div x-data="{ fileName: '' }">
        <label class="block text-xs font-bold text-[#1C1A17] mb-1.5">Add-on Image (Optional)</label>
