<a
    ...
    class="group relative overflow-hidden rounded-2xl border bg-white p-4 text-left shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md focus:outline-none {{ $activeTab === $tabKey ? 'border-[#E8642A] bg-[#FFF8F3]' : 'border-[#EDE4D8] hover:bg-[#FDF6EE]' }}"
>
    ...
    <div class="mb-4 flex items-start justify-between gap-3">
        ...
        <span class="rounded-full px-2 py-1 text-[11px] font-bold {{ $activeTab === $tabKey ? 'bg-[#E8642A] text-white' : 'bg-[#F6EFE7] text-[#8A6D3F]' }}">Open</span>
    </div>
