        ...
        <main class="flex-1 py-8">
            <div class="max-w-6xl mx-auto px-4">
                ...
                <div id="booking-request" class="mb-8 bg-white rounded-2xl p-6 border border-[#EDE4D8] shadow-sm scroll-mt-24">
                    ...
                    <form method="POST" action="{{ route('client.bookings.store', $caterer) }}" class="grid md:grid-cols-[1.3fr_1fr_0.8fr_auto] gap-3">
                        @csrf
                        <div>
                        ...
                        <div class="flex items-end">
                            <button type="submit" class="w-full px-6 py-3 rounded-xl bg-[#E8642A] text-white text-sm font-bold hover:bg-[#F07C42] transition-colors whitespace-nowrap">
                                Send Request
                            </button>
                        </div>
                    </form>
